  ...
  return (
      <>
        <Form className="d-flex" onSubmit={handleSubmit}>
          <Form.Group className="btn-email mb-md-3">
              <Form.Control type="email" name="email" onChange={handleChange} className="form-control form-border" placeholder="Masukkan Email Kamu" isInvalid={!!errors.email} style={{width: "30vw"}}/>
